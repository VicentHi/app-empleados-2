...
export class ActualizarComponentComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    let empleado:Empleado=this.empleadosService.encontrarEmpleado(this.indice);   //creamos objeto empleado, llamamos al metodo pasandole en indice para que encuente el empleado 
